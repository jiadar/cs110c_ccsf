...
public abstract class LinkedChainBase<T> {
    ...
    /**
     * Public Methods: Subclasses do not need to overwrite these
     */
    ...
    /**
     * These are the protected helper methods. Subclasses can use these
     * methods to implement the List functionality
     */
    
    protected final Node traverseToNodeAt(int givenPosition) {
